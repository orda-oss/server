...
pub async fn list(
    ...
    ChannelService::list(station, filter).await
}
...
pub async fn update(
    ...
    ChannelService::update(station, id, payload, user_id, is_owner).await
}
...
pub async fn delete(
    ...
    ChannelService::delete(station, id, user_id, is_owner).await
}
