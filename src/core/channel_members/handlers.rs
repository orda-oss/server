...
use crate::{
    core::channel_members::dto::{AddMemberDto, ListMemberDto, MemberFilterDto},
    utils::{
        response::ApiResult,
...
pub async fn add_member(
    ...
    MembershipService::add_member(station, channel_id, user_id, payload.user_id).await
}
...
pub async fn remove_member(
    ...
    MembershipService::remove_member(station, channel_id, user_id, target_user_id).await
}
